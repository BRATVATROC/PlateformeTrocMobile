...
//                         rec.getForm().show();
        ...
        Container list = new InfiniteContainer() {
            ...
            public Component[] fetchComponents(int index, int amount) {
                ...
                Component[] elements = new Component[amount+1];
...
//                        line1.add(idA2Label);
                        ...
                        b.addActionListener(new ActionListener() {
                            ...
                            public void actionPerformed(ActionEvent evt) {
                                ...
                                if(Dialog.show("Info", "Ordred on "+p.getDateCommande(), "OK", "Details")){
                                    //System.out.println("ok");
                                }else {
//                                    CommandeService ser = new CommandeService();
//                                    ser.remove(p.getNumCommande());
//                                      AffichageCommande affComm = new AffichageCommande(p.getNumCommande());
//                                      //System.out.println(p.getNumCommande());
//                                      affComm.setIdCommande(p.getNumCommande());
//                                      affComm.getF().show();
                                }
                            }
                        });
                        ...
                        b.addActionListener(new ActionListener() {
                            ...
                            public void actionPerformed(ActionEvent evt) {
                                if(Dialog.show("Info", "Ordred on "+p.getDateCommande()+"" , "OK", "Details")){
                                    ...
                                    AffichageCommande affComm = new AffichageCommande(p.getNumCommande());
                                      System.out.println(p.getNumCommande());
//                                      MyApplication.idCommande=p.getNumCommande();
                                      affComm.getF().show();
                                }
