...
import service.ServiceAlloCoursierNonLivr;
...
public AlloCoursierToDeliv()
{
 t.getToolbar().addCommandToRightBar("Back", null, ev->{
                                    ...
                                    t.add(msg1).add(msg2);
                                       ...
                                       btn.add(show);
                                        ServiceAlloCoursierNonLivr list= new ServiceAlloCoursierNonLivr();
                               ...
                               public void actionPerformed(ActionEvent evt) {
                                      ...
                                      s.getToolbar().addCommandToLeftBar("My List", null, ev->{
                                        AlloCoursierToDeliv a = new AlloCoursierToDeliv();
                                         a.getT().show();
                                      });
