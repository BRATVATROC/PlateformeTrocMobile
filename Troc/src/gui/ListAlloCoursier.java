 ...
 * @author Lenovo
 */
public class ListAlloCoursier {
                     Form t = new Form();
                     Form f = new Form(new FlowLayout(CENTER,TOP));
                     
                      
                        public ListAlloCoursier(){
                            
                            f.getToolbar().addCommandToRightBar("Back", null, ev->{
                                        Acceuil a = new Acceuil();
                                         a.getF().show();
                             });
                             Label msg1= new Label("WeTrov Delevery Service offers you a ");
                            ...
                            list1.addActionListener(new ActionListener() {
                                ...
                                public void actionPerformed(ActionEvent evt) {
                                    AlloCoursierDeliv li=new AlloCoursierDeliv() ;
                                    li.getT().show();
                                                                  }
                            });
                            ...
                            list2.addActionListener(new ActionListener() {
                                @Override
                                public void actionPerformed(ActionEvent evt) {
                                    AlloCoursierToDeliv lis=new AlloCoursierToDeliv();
                                    lis.getT().show();
                                }
                            });
                            ...
                            list3.addActionListener(new ActionListener() {
                                @Override
                                public void actionPerformed(ActionEvent evt) {
                                    AlloCoursierCanceled lis= new AlloCoursierCanceled() ;
                                    lis.getT().show();
                                }
                            });
