    ...
    public LivraisonCanceled() {
         t.getToolbar().addCommandToRightBar("Back", null, ev->{
                                    ...
                                    t.add(msg1).add(msg2);
                                     ...
                                     ServiceLivraisonCanceled list= new ServiceLivraisonCanceled();
                               ...
                               public void actionPerformed(ActionEvent evt) {
                                      ...
                                      s.getToolbar().addCommandToLeftBar("My List", null, ev->{
                                          ...
                                          LivraisonCanceled c=new LivraisonCanceled();
                                        c.getT().show();
                                      });
