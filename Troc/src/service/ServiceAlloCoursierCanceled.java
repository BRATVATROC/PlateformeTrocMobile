 ...
 * @author Lenovo
 */
public class ServiceAlloCoursierCanceled {
...
//                e.setDateLivraison(mydate2);
     ...
     public ArrayList<Livraison> getListOrders2(){       
        ...
        con.setUrl("http://localhost/PlateformeTROC/ProjetWebTroc/web/app_dev.php/troc/listeCanceled/"+MyApplication.current_user.getId());  
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                ServiceAlloCoursierCanceled ser = new ServiceAlloCoursierCanceled();
