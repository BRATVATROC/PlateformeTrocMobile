 ...
 * @author Lenovo
 */
public class ServiceAlloCoursierReçue {
    ...
    public ArrayList<Livraison> getListOrders1(){       
        ...
        con.setUrl("http://localhost/PlateformeTROC/ProjetWebTroc/web/app_dev.php/troc/listedelivered/"+MyApplication.current_user.getId());  
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                ServiceAlloCoursierReçue ser = new ServiceAlloCoursierReçue();
