 ...
 * @author Lenovo
 */
public class ServiceLivraisonCanceled {
    public ArrayList<Livraison> ListDeliveredOrdersCanceled(String json)
    {
...
//                e.setDateLivraison(mydate2);
                ...
                e.setDescription(obj.get("titreAnnonce").toString());
     ...
     public ArrayList<Livraison> getListOrders2(){       
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/PlateformeTROC/ProjetWebTroc/web/app_dev.php/troc/listeCanceledLiv/"+MyApplication.current_user.getId());  
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                ServiceLivraisonCanceled ser = new ServiceLivraisonCanceled();
                System.out.println("test  "+con.getResponseData());
                listOrders = ser.ListDeliveredOrdersCanceled(new String(con.getResponseData()));
            }
        });
