 ...
 * @author Lenovo
 */
public class ServiceLivraisonNonLivr {
...
//                System.out.println(mydate);
    ...
    public ArrayList<Livraison> getListOrders1(){       
        ...
        con.setUrl("http://localhost/PlateformeTROC/ProjetWebTroc/web/app_dev.php/troc/listeToDelivLiv/"+MyApplication.current_user.getId());  
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                ServiceLivraisonNonLivr ser = new ServiceLivraisonNonLivr();
