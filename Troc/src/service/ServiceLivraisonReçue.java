 ...
 * @author Lenovo
 */
public class ServiceLivraisonReçue {
    public ArrayList<Livraison> ListDeliveredOrdersLivraison(String json)
    {
    ...
    public ArrayList<Livraison> getListOrders1(){       
        ...
        con.setUrl("http://localhost/PlateformeTroc/ProjetWebTroc/web/app_dev.php/troc/listedeliveredLiv/"+MyApplication.current_user.getId());  
      
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                ServiceLivraisonReçue ser = new ServiceLivraisonReçue();
                System.out.println("test  "+con.getResponseData());
                listOrders = ser.ListDeliveredOrdersLivraison(new String(con.getResponseData()));
            }
        });
